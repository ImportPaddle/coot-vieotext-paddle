...
# ---------- Multiprocessing ----------
from nntrainer import initializers
from nntrainer.initializers import normal_
...
def get_truncnorm_tensor(shape: Tuple[int], *, mean: float = 0, std: float = 1, limit: float = 2) -> paddle.Tensor:
    """
