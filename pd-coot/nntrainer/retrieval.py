...
def compute_retrieval(data_collector: Dict[str, paddle.Tensor], key1: str, key2: str, print_fn: Callable = print) -> (
    ...
    Args:
        ...
        print_fn: Function to print the results wipaddle.
    ...
    if isinstance(emb1, paddle.Tensor):
        emb1 = emb1.numpy()
    if isinstance(emb2, paddle.Tensor):
        emb2 = emb2.numpy()
