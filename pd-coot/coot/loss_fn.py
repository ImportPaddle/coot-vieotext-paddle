...
def cosine_sim(visual_emb: paddle.Tensor, text_emb: paddle.Tensor) -> paddle.Tensor:
    """
...
class CycleConsistencyLoss(nn.Layer):
    """
    ...
    def get_total_loss(self, emb_orig, emb_nn, emb_mask, emb_lens, emb_max_len, beta, beta_raw):
        ...
        Args:
            ...
            emb_max_len: int, paddle.max over emb lens dim -1
    ...
    def compute_loss_index_gauss(self, emb_mask, _emb_lens, emb_max_len, beta):
        ...
        Args:
            ...
            emb_max_len: paddle.max over emb_lens dim -1
        ...
        index_nn = paddle.sum(idx_orig.unsqueeze(1) * beta, axis=-1)
        # shape (batch, seq_len)
        ...
        variance = paddle.sum(distance * beta, axis=-1)
