...
from nntrainer.utils_paddle import create_shared_array
...
class VideoFeatureLoader:
    ...
    def get_features_as_items(self, *, load_all: bool = False):
        ...
        Args:
            load_all: If true, ignores the provided data keys and loops everything in the papaddle.
