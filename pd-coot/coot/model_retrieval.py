...
class RetrievalVisualEmbTuple(typext.TypedNamedTuple):
    ...
    """
    vid_emb: paddle.Tensor
    clip_emb: paddle.Tensor
    vid_context: paddle.Tensor
    clip_emb_reshape: paddle.Tensor
    clip_emb_mask: paddle.Tensor
    clip_emb_lens: paddle.Tensor
...
class RetrievalTextEmbTuple(typext.TypedNamedTuple):
    ...
    """
    par_emb: paddle.Tensor
    sent_emb: paddle.Tensor
    par_context: paddle.Tensor
    sent_emb_reshape: paddle.Tensor
    sent_emb_mask: paddle.Tensor
    sent_emb_lens: paddle.Tensor
